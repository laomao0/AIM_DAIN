...
class DepthFlowProjectionLayer(Function):
    ...
    def forward(self, input1,input2):
        ...
        if input1.is_cuda :
            ...
            err = my_lib.DepthFlowProjectionLayer_gpu_forward(input1,input2, count,output, self.fillhole)
        else:
            ...
            err = my_lib.DepthFlowProjectionLayer_cpu_forward(input1,input2, count, output,self.fillhole)
        if err != 0:
            print(err)
    ...
    def backward(self, gradoutput):
        ...
        if self.input1.is_cuda:
            ...
            err = my_lib.DepthFlowProjectionLayer_gpu_backward(self.input1,self.input2,
                                                               self.count, self.output,
            ...
            err = my_lib.DepthFlowProjectionLayer_cpu_backward(self.input1, self.input2,
                                                               self.count, self.output,
                                                               gradoutput, gradinput1,gradinput2)
            # print(err)
            if err != 0:
...
class FlowFillholelayer(Function):
    ...
    #         # print("CUDA backward")
    #         gradinput1 = gradinput1.cuda(self.device)
    #         err = my_lib.DepthFlowProjectionLayer_gpu_backward(self.input1, self.count, gradoutput, gradinput1)
    #         # print(err)
    #         if err != 0 :
    #             print(err)
    #
    ...
    #         # print("CPU backward")
    #         # print(gradoutput)
    #         err = my_lib.DepthFlowProjectionLayer_cpu_backward(self.input1, self.count,  gradoutput, gradinput1)
    #         # print(err)
    #         if err != 0:
    #             print(err)
    #         # print(gradinput1)
