...
DO_AIMTest = False
AIM_EVAL_DATA = "/home/shenwang/PycharmProjects/Dataset/AIM_challenge/val/val_15fps"
AIM_EVAL_RESULT = "/home/shenwang/PycharmProjects/Dataset/AIM_challenge/val/val_result"
# if not os.path.exists(AIM_EVAL_RESULT):
#     os.mkdir(AIM_EVAL_RESULT)
...
val_fps = int(args.val_fps)  # 15->30fps
